document.addEventListener("DOMContentLoaded", function(event) {
  ...
  document.querySelector(".chaptersectionlist h3").innerHTML = "Sections in this seminar";

  Array.from(document.querySelectorAll('.angry')).forEach(el => el.innerHTML = `<div class="bubble">${el.innerHTML}</div>`);
